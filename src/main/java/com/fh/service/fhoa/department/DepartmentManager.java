...
public interface DepartmentManager{
	 ...
	 * @throws Exception
     */
	List<Department> listSubDepartmentByCompanyId(String companyId) throws Exception;
	/**
	 ...
	 * @throws Exception
     */
	List<Department> listAllDepartmentByCompanyId(String companyId) throws Exception;
	/**
