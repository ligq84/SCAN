...
public class DepartmentService implements DepartmentManager{
	 ...
	 * @throws Exception
     */
	public List<Department> listSubDepartmentByCompanyId(String companyId) throws Exception {
		return (List<Department>) dao.findForList("DepartmentMapper.listSubDepartmentByCompanyId", companyId);
	}
	 ...
	 * @throws Exception
     */
	public List<Department> listAllDepartmentByCompanyId(String companyId) throws Exception {
		List<Department> departmentList = this.listSubDepartmentByCompanyId(companyId);
		for(Department depar : departmentList){
			depar.setTreeurl("department/list.do?DEPARTMENT_ID="+depar.getDEPARTMENT_ID());
			depar.setSubDepartment(this.listAllDepartment(depar.getDEPARTMENT_ID()));
			depar.setTarget("treeFrame");
