								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.POSTAL_CODE}</td>
											<td class='center'>${var.NATURE}</td>
											<td class='center'>${var.BUSINESS_LICENSE}</td>
											<td class='center'>${var.ORGANIZATION_NUMBER}</td>
											<td class='center'>${var.ECONOMIC_TYPE}</td>
											<td class='center'>${var.REGISTERED_CAPITAL}</td>
											<td class='center'>${var.COMPANY_URL}</td>
											<td class='center'>${var.ISSUING_AUTHORITY}</td>
											<td class='center'>${var.START_TIME}</td>
											<td class='center'>${var.END_TIME}</td>
											<td class='center'>${var.CORPORATION}</td>
											<td class='center'>${var.TECHNOLOGY_DIRECTOR}</td>
											<td class='center'>${var.FINANCIAL_PRINCIPAL}</td>
											<td class='center'>${var.NUMBER_EMPLOYEE}</td>
											<td class='center'>${var.NUMBER_PM}</td>
											<td class='center'>${var.NUMBER_SENIOR}</td>
											<td class='center'>${var.NUMBER_INTERMEDIATE}</td>
											<td class='center'>${var.NUMBER_PRIMARY}</td>
											<td class='center'>${var.NUMBER_TOTAL}</td>
											<td class='center'>${var.COMPANY_DESC}</td>
											<td class='center'>${var.CONTACTS_NAME}</td>
											<td class='center'>${var.CONTACTS_TELEPHONE}</td>
											<td class='center'>${var.CONTACTS_MAIL}</td>
											<td class='center'>${var.CONTACTS_FAX}</td>
											<td class='center'>${var.START_BANK}</td>
											<td class='center'>${var.BRANCH_BANK}</td>
											<td class='center'>${var.ACCOUNT_BANK}</td>
											<td class='center'>${var.IMAGE_BUSINESS}</td>
											<td class='center'>${var.IMAGE_ORGANIZATION}</td>
											<td class='center'>${var.IMAGE_SECURITY}</td>
											<td class='center'>${var.IMAGE_CORPORATION_IDCARD_POSITIVE}</td>
											<td class='center'>${var.IMAGE_CORPORATION_IDCARD_SIDE}</td>
											<td class='center'>${var.IMAGE_OTHER1}</td>
											<td class='center'>${var.IMAGE_OTHER2}</td>
											<td class='center'>${var.IMAGE_OTHER3}</td>
											<td class='center'>${var.IMAGE_OTHER4}</td>
											<td class='center'>${var.IMAGE_OTHER5}</td>
											<td class="center">
