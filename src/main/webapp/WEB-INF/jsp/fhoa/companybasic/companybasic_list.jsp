			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="companybasic/${pd.TYPE}List.do" method="post" name="Form" id="Form">
						...
						<table style="margin-top:5px;">
							<tr>
								<td  class="searchTabletd">
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入关键词" class="nav-search-input" id="nav-search-input" autocomplete="off"
												   name="keywords" value="${pd.keywords }" placeholder="这里输入关键词" style="width: 145px;"/>
								...
								<td class="searchTabletd">
									<div class="nav-search">
										<select class="nav-search-input" name="STATUS" id="STATUS" style="width: 145px;" >
								...
								<td  class="searchTabletd">
									...
									<c:if test="${QX.add == 1 }">
										<a class="btn btn-mini btn-qg" onclick="add();">新增</a>
									</c:if>
								</td>
								</c:if>
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">
												...
												<div class=" btn-group">
													<c:if test="${QX.edit == 1 }">
													<a  title="编辑" onclick="edit('${var.OCBID}');">
														<img src="/static/images/edit.png" />
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a  onclick="del('${var.OCBID}');">
	...
	<script type="text/javascript">
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>companybasic/delete.do?OCBID="+Id+"&TYPE=${pd.TYPE}&tm="+new Date().getTime();
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>companybasic/excel.do';
		}
	</script>
