			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<table id="simple-table" class="table-striped table-bordered table-hover" style="margin-top:5px;margin-bottom: 20px;background-color: transparent;border-collapse: collapse;border-spacing: 0;width: 2088px;">
							<thead>
								<tr>
