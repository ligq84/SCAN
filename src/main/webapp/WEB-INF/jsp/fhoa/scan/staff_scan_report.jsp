			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="scan/staffScanReport.do" method="post" name="Form" id="Form">
							<input type="hidden" name="scan_type" value="${pd.scan_type}">
						<table style="margin-top:5px;">
							<tr>
								<td class="searchTabletd" style="text-align: right"><label>人员名称:</label></td>
								<td class="searchTabletd">
									<div class="nav-search">
										<input type="text" placeholder="人员名称" class="nav-search-input" id="machineName" autocomplete="off"
						...
						<table id="simple-table" class="table-striped table-bordered table-hover" style="margin-top:20px;background-color: transparent;border-collapse: collapse;border-spacing: 0;width: 2088px;">
							<thead>
								<tr>
									...
									<th class="center" style="width:120px;" rowspan="2">人员名称</th>
									<th class="center"  style="width:120px;" rowspan="2">所属部门</th>
